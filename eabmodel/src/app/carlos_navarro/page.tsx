      ...
      <main className="max-w-6xl mx-auto relative z-10">
        ...
        <section id="sobre-mi" className="flex flex-col items-center gap-5 mt-10">
          <div className="title_section text-center">
            <h2 className="text-3xl md:text-5xl lg:text-7xl font-bold border-b-4 border-gray-400 pb-2">Sobre Mi</h2>
          </div>
          ...
          <div className="stat-item text-center bg-gray-900 bg-opacity-40 p-4 rounded">
            <div className="stat-number text-4xl">+<span className="numbers-font" data-value="2">0</span></div>
            <div className="stat-text text-xl">Años de experiencia</div>
          </div>
          <div className="stat-item text-center bg-gray-900 bg-opacity-40 p-4 rounded">
            <div className="stat-number text-4xl">+<span className="numbers-font" data-value="30">0</span></div>
            <div className="stat-text text-xl">Clientes Satisfechos</div>
          </div>
          <div className="stat-item text-center bg-gray-900 bg-opacity-40 p-4 rounded">
            <div className="stat-number text-4xl">+<span className="numbers-font" data-value="15">0</span></div>
            <div className="stat-text text-xl">Sitios Web Entregados</div>
          </div>
          <div className="stat-item text-center bg-gray-900 bg-opacity-40 p-4 rounded">
            <div className="stat-number text-4xl">+<span className="numbers-font" data-value="10">0</span></div>
            <div className="stat-text text-xl">Certificaciones</div>
          </div>
              </div>
            </div>
          </div>
          ...
          <div className="skills-grid grid grid-cols-1 md:grid-cols-3 gap-5 mt-6">
            <div className="skill-category p-5 rounded">
              ...
              <div className="row grid grid-cols-2 gap-3">
                ...
                <div className="skill flex items-center justify-center p-3 bg-gray-900 bg-opacity-40 rounded">
                  <Image width={400} height={400}  src="/imgs/bootstrap-5-1.svg" alt="Bootstrap" className="w-10 h-10 mx-2" />
            ...
            <div className="skill-category p-5 rounded">
              ...
              <div className="row grid grid-cols-2 gap-3">
                ...
                <div className="skill flex items-center justify-center p-3 bg-gray-900 bg-opacity-40 rounded">
                  <Image width={400} height={400}  src="/imgs/aws-logo.svg" alt="AWS" className="w-10 h-10 mx-2" />
            ...
            <div className="skill-category p-5 rounded">
              <div className="row flex items-center justify-center mb-5">
                ...
                <h3 className="text-2xl font-bold">Colaboración</h3>
              </div>
              <div className="row grid grid-cols-2 gap-3">
                <div className="skill flex items-center justify-center p-3 bg-gray-900 bg-opacity-40 rounded">
        ...
        <section id="experiencia" className="py-8">
          <div className="title_section text-center">
            <h2 className="text-3xl md:text-5xl lg:text-7xl font-bold border-b-4 border-gray-400 pb-2">Experiencia</h2>
          </div>
          <div className="job-info text-center">
            <h3 className="text-3xl md:text-4xl font-bold">Axol Marketing</h3>
            <p className="text-xl numbers-font opacity-80">(2022-hoy)</p>
          </div>
          <br />
          <div className="job-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-8">
            ...
            <div className="job-item bg-gray-900 bg-opacity-40 rounded p-5 flex flex-col items-center text-center">
              ...
              <h4 className="text-2xl font-bold mb-2">Optimización web</h4>
              <p className="text-lg">SEO, diseño responsivo y velocidad de carga</p>
            </div>
            <div className="job-item bg-gray-900 bg-opacity-40 rounded p-5 flex flex-col items-center text-center">
              <Image width={400} height={400}  src="/imgs/desarrollador-de-software.png" alt="Desarrollo web" className="w-12 h-12 mb-3" />
              <h4 className="text-2xl font-bold mb-2">Desarrollo web</h4>
              <p className="text-lg">HTML, CSS, JavaScript y frameworks relacionados</p>
            </div>
            <div className="job-item bg-gray-900 bg-opacity-40 rounded p-5 flex flex-col items-center text-center">
              <Image width={400} height={400}  src="/imgs/analitica.png" alt="Análisis de datos" className="w-12 h-12 mb-3" />
              <h4 className="text-2xl font-bold mb-2">Análisis de datos</h4>
              <p className="text-lg">Looker Studio, Google y Facebook Analytics</p>
            </div>
            <div className="job-item bg-gray-900 bg-opacity-40 rounded p-5 flex flex-col items-center text-center">
              <Image width={400} height={400}  src="/imgs/agente-de-servicio-al-cliente.png" alt="Capacitaciones" className="w-12 h-12 mb-3" />
              <h4 className="text-2xl font-bold mb-2">Capacitaciones</h4>
              <p className="text-lg">Sesiones de instrucción en todas estas herramientas</p>
            </div>
          </div>
        </section>
        ...
        <section id="contacto" className="py-8">
          <div className="title_section text-center">
            <h2 className="text-3xl md:text-5xl lg:text-7xl font-bold border-b-4 border-gray-400 pb-2">Contáctame</h2>
          </div>
